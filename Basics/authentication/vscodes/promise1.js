...
mongoose.connect('mongodb://127.0.0.1/playerslistdb',{ useNewUrlParser: true } )
...
app.get('/players', (req, res) => {
    const db = mongoose.conection;
        mongoose.connect('mongodb://127.0.0.1/playerslistdb', (err,db)  => {
...
app.delete('/players', (req, res) => {
    const id = req.body.id;
    mongoose.connect('mongodb://127.0.0.1/playerslistdb', function (err, db) {
        const dbo = db.db('playersdb'),
              myobj = { idnumber: id };
